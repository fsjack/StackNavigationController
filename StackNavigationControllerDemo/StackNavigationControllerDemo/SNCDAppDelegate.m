...
#import "SNCDAppDelegate.h"
#import "SNCDViewController.h"
#import "StackNavigationController.h"

@implementation SNCDAppDelegate

- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    self.window = [[UIWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
    // Override point for customization after application launch.
    self.viewController = [[SNCDViewController alloc] init];
#if 1
    SNBaseNavigationController *navigationController = [SNBaseNavigationController navigationWithRootController:self.viewController
